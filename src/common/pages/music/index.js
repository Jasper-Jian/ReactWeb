...
export default class Music extends React.Component {
    ...
    fetchTableData = (typeId, searchFields) => {
        //百度音乐免费API接口
        fetchJsonp(`http://tingapi.ting.baidu.com/v1/restserver/ting?xml&calback=&from=webapp_music&method=baidu.ting.billboard.billList&type=${typeId}&size=1000&offset=0`, {
                method: 'GET'
            })
            .then((res) => {
                return res.json();
